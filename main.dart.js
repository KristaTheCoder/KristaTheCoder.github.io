...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    "^": "",
    main: [function() {
      var $async$goto = 0, $async$completer = P.Completer_Completer$sync(), t1, countdown, i;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = document;
              countdown = t1.querySelector("#countdown");
              i = 100;
            case 2:
              // for condition
              if (!(i >= 0)) {
            ...
            case 4:
              // after for
              t1.querySelector("#puns").textContent = "You broke my dart </3";
              // implicit return
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [P.int,,]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [,,]}];
